...
+ (NSDictionary *)amk_emojiMappingOfUnicodeToCheatCodes {
    ...
    dispatch_once(&onceToken, ^{
        mapping = @{@"😄": @":smile:",
                    ...
                    @"😚": @":kissing_closed_eyes:",
                    @"😳": @":flushed:",
                    @"😥": @[@":relieved:", @":disappointed_relieved:"],
                    @"😌": @":satisfied:",
                    @"😁": @":grin:",
                    @"😉": @[@":wink:", @";)", @";-)"],
                    @"😜": @[@":wink2:", @":P", @":stuck_out_tongue_winking_eye:"],
                    ...
                    @"🔈": @":speaker:",
                    @"📩": @[@":envelope_with_downwards_arrow_above:", @":envelope_with_arrow:"],
                    @"📦": @":package:",
                    @"📖": @[@":open_book:", @":book:"],
                    @"🚋": @":tram_car:",
                    @"🔙": @[@":back_with_leftwards_arrow_above:", @":back:"],
                    @"▪" : @":black_small_square:",
                    @"▫" : @":white_small_square:",
                    @"◼": @":black_medium_square:",
                    @"◻": @":white_medium_square:",
...
+ (NSDictionary *)amk_emojiMappingOfCheatCodesToUnicode {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [emojiMappingOfUnicodeToCheatCodes enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop) {
            if ([obj isKindOfClass:[NSArray class]]) {
                for (NSString *object in obj) {
                    [(NSMutableDictionary *)emojiMappingOfCheatCodesToUnicode setObject:key forKey:object];
                }
            } else {
                [(NSMutableDictionary *)emojiMappingOfCheatCodesToUnicode setObject:key forKey:obj];
            }
        }];
